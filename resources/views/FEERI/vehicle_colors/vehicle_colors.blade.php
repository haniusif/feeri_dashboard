...
@section('title', __('Vehicle Colors') )
...
<div class="row">
 <div class="breadcrumb-wrapper col-12">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active">{{ __('Vehicle Colors') }}
            </li>
        </ol>
    </div>
     @include('_partials.alerts')
     @include('FEERI.vehicle_colors.search.search')
    <div class="col-12">
    <div class="card">
                    <div class="card-body">
                      <div class="card-title header-elements">
                        <h5 class="m-0 me-2">{{ __('Vehicle Colors') }}</h5>
...
<th  >{{ __('vehicle_colors_name') }}</th>
<th  >{{ __('vehicle_colors_en_name') }}</th>
<th  >{{ __('vehicle_colors_color_code') }}</th>
...
<td>{{ $vehicle_color->name }}</td>
<td>{{ $vehicle_color->en_name }}</td>
<td>{{ $vehicle_color->color_code }}</td>
<td>
<span class="badge bg-label-{{ ($vehicle_color->is_active == 1) ? __("success") : __("danger") }} ">
{{ ($vehicle_color->is_active == 1) ? __("YES") : __("NO") }}
</span>
</td>
...
<td>{{ $vehicle_color->updated_at }}</td>         <td>
 ...
 @endforeach
        ...
        <tfoot>
       <tr><td      colspan="7"  >{{$vehicle_colors->links("pagination::bootstrap-4")}} </td></tr>
        </tfoot>
</table>
                                    </div>
                                </div>
