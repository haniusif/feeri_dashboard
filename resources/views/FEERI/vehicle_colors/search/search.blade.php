                ...
                <form action="{{ route('vehicle_colors.index') }}" method="GET">
                    <div class="row">
                                          ...
                                          <div class="col-12 col-sm-6 col-lg-3">
                                                <label for="vehicle_colors-list-name">{{ __('vehicle_colors_name') }}</label>
                                                <fieldset class="form-group">
                                                    <input class="form-control" name="name" value="{{ request()->name }}"  type="text" placeholder="{{ __('vehicle_colors_name') }}"  />

                                                </fieldset>
                                            </div>

                                          <div class="col-12 col-sm-6 col-lg-3">
                                                <label for="vehicle_colors-list-en_name">{{ __('vehicle_colors_en_name') }}</label>
                                                <fieldset class="form-group">
                                                    <input class="form-control" name="en_name" value="{{ request()->en_name }}"  type="text" placeholder="{{ __('vehicle_colors_en_name') }}"  />

                                                </fieldset>
                                            </div>

                                          <div class="col-12 col-sm-6 col-lg-3">
                                                <label for="vehicle_colors-list-color_code">{{ __('vehicle_colors_color_code') }}</label>
                                                <fieldset class="form-group">
                                                    <input class="form-control" name="color_code" value="{{ request()->color_code }}"  type="text" placeholder="{{ __('vehicle_colors_color_code') }}"  />
