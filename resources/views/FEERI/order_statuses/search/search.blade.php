...
<div class="card mb-4">
                    ...
                    <div class="row">
                                          ...
                                          <div class="col-12 col-sm-6 col-lg-3">
                                                ...
                                                <fieldset class="form-group">
                                                    <input class="form-control" name="name" value="{{ request()->name }}"  type="text" placeholder="{{ __('order_statuses_name') }}"  />
                                          ...
                                          <div class="col-12 col-sm-6 col-lg-3">
                                                ...
                                                <fieldset class="form-group">
                                                    <input class="form-control" name="en_name" value="{{ request()->en_name }}"  type="text" placeholder="{{ __('order_statuses_en_name') }}"  />

                                                </fieldset>
                                            </div>

                                          <div class="col-12 col-sm-6 col-lg-3">
                                                <label for="order_statuses-list-is_active">{{ __('order_statuses_is_active') }}</label>
                                                <fieldset class="form-group">
                                                    <select  name="is_active" class="form-control" id="order_statuses-list-is_active">
 ...
 <div class=" mt-3">
                                                ...
                                                <a href="{{ route('order_statuses.index') }}" class="btn btn-link" >{{ __('Reset') }}</a>
                                            </div>
            </div>
                                    </form>
                                </div>
